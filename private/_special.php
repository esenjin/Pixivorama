<?php
// ============================================================
//  private/_special.php — Template galerie spéciale Pixiv
//  Types : illust | bookmark | history | following
...
$type_labels = [
    'illust'    => 'Mes illustrations',
    'bookmark'  => 'Mes bookmarks',
...
$type_hint = $type_labels[$gallery_type] ?? $gallery_type;
$icon      = $type_icon[$gallery_type]  ?? '·';

// Seul "illust" supporte le tri par popularité (via bookmarks ça n'a pas de sens non plus)
...
<header>
    <p class="site-label">
        ...
        <span style="color:var(--accent);opacity:.8;"><?= htmlspecialchars($icon . ' ' . $type_hint) ?></span>
    </p>
